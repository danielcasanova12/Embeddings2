...
def load_model(model_name: str = "wavlm-base-plus"):
...
def main():
    parser = argparse.ArgumentParser(description="Extrai embeddings acústicos usando WavLM.")
    ...
    parser.add_argument("-o", "--output-dir-name", default="output_wavlm", help="Nome do diretório de saída")
    parser.add_argument("-m", "--model-name", choices=list(MODELS.keys()), default="wavlm-base-plus")
