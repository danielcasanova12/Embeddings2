...
def load_model(model_name: str = "hubert-base"):
...
def main():
    parser = argparse.ArgumentParser(description="Extrai embeddings acústicos usando HuBERT.")
    ...
    parser.add_argument("-o", "--output-dir-name", default="output_hubert", help="Nome do diretório de saída")
    parser.add_argument("-m", "--model-name", choices=list(MODELS.keys()), default="hubert-base")
